 ...
 */
/**
 * Brand - product relation edit block
 *
 * @category    Zozoconcepts
 * @package     Zozoconcepts_Brands
 * @author      Zozoconcepts Hybrid
 */
class Zozoconcepts_Brands_Block_Adminhtml_Brand_Edit_Tab_Product
     ...
     * @access protected
     * @return Zozoconcepts_Brands_Block_Adminhtml_Brand_Edit_Tab_Product
     * @author Zozoconcepts Hybrid
     */
     ...
     * get row url
     * @access public
     * @param Zozoconcepts_Brands_Model_Product
     * @return string
     * @author Zozoconcepts Hybrid
     */
