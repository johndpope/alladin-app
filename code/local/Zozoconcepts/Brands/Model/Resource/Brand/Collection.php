 ...
 */
/**
 * Brand collection resource model
 *
 * @category    Zozoconcepts
 * @package     Zozoconcepts_Brands
 * @author      Zozoconcepts Hybrid
 */
class Zozoconcepts_Brands_Model_Resource_Brand_Collection
    ...
    protected function _renderFiltersBefore(){
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                array('store_table' => $this->getTable('zozoconcepts_brands/brand_store')),
    ...
    public function addProductFilter($product){
        ...
        if (!isset($this->_joinedFields['product'])){
            $this->getSelect()->join(
                array('related_product' => $this->getTable('zozoconcepts_brands/brand_product')),
    ...
    public function addCategoryFilter($category){
        ...
        if (!isset($this->_joinedFields['category'])){
            $this->getSelect()->join(
                array('related_category' => $this->getTable('zozoconcepts_brands/brand_category')),
                'related_category.brand_id = main_table.entity_id',
                array('position')
            );
