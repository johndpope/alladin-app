 ...
 */
class Zozoconcepts_Brands_Model_Resource_Brand
    ...
    public function _construct(){
        $this->_init('zozoconcepts_brands/brand', 'entity_id');
    }
    /**
    ...
    public function lookupStoreIds($brandId){
        ...
        $select  = $adapter->select()
            ->from($this->getTable('zozoconcepts_brands/brand_store'), 'store_id')
     ...
     * @return Zozoconcepts_Brands_Model_Resource_Brand
     * @author Zozoconcepts Hybrid
     */
     ...
     * @param string $field
     * @param mixed $value
     * @param Zozoconcepts_Brands_Model_Brand $object
    ...
    protected function _getLoadSelect($field, $value, $object){
        ...
        if ($object->getStoreId()) {
            ...
            $select->join(
                array('brands_brand_store' => $this->getTable('zozoconcepts_brands/brand_store')),
    ...
    protected function _afterSave(Mage_Core_Model_Abstract $object){
        ...
        $table  = $this->getTable('zozoconcepts_brands/brand_store');
    ...
    protected function _initCheckUrlKeySelect($urlKey, $store){
        $select = $this->_getReadAdapter()->select()
            ...
            ->join(
                array('es' => $this->getTable('zozoconcepts_brands/brand_store')),
