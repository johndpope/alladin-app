 ...
 */
class Zozoconcepts_Brands_Controller_Router
    extends Mage_Core_Controller_Varien_Router_Abstract {
    /**
     * init routes
     * @access public
     * @param Varien_Event_Observer $observer
     * @return Zozoconcepts_Brands_Controller_Router
     * @author Zozoconcepts Hybrid
     */
    public function initControllerRouters($observer){
        $front = $observer->getEvent()->getFront();
        $front->addRouter('zozoconcepts_brands', $this);
        return $this;
    }
    /**
    ...
    public function match(Zend_Controller_Request_Http $request){
        ...
        $check['brand'] = new Varien_Object(array(
            'prefix'        => Mage::getStoreConfig('zozoconcepts_brands/brand/url_prefix'),
            'suffix'        => Mage::getStoreConfig('zozoconcepts_brands/brand/url_suffix'),
            'model'         =>'zozoconcepts_brands/brand',
            'controller'    => 'brand',
            'action'        => 'view',
            'param'         => 'id',
            'check_path'    => 0
