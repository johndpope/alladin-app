...
class Zozoconcepts_Ajaxcatalog_Block_Ajax extends Mage_Core_Block_Template{
	public function __construct(){
		...
		if($this->loadingImage == '' || $this->loadingImage == null){
			...
			$this->loadingImage = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA).'zozoconcepts/ajaxcatalog/'.$this->loadingImage;
		}	
	}
