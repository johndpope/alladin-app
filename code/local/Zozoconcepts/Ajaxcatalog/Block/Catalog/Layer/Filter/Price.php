...
class Zozoconcepts_Ajaxcatalog_Block_Catalog_Layer_Filter_Price extends Mage_Catalog_Block_Layer_Filter_Price 
{
	...
	*/
	public function __construct(){
        ...
        $this->_imagePath = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA).'zozoconcepts/ajaxcatalog/';            
        parent::__construct();            
	}
	...
	*/
	...
	public function prepareCustomStyles(){
		...
		$html = '<style type="text/css">';	
			...
			if($bgHandle){$html .= 'background:'.$bgHandle.' !important;';}
			$html .= 'width:'.$handleWidth.'px !important; height:'.$handleHeight.'px !important; border: 0; margin-top: -1px; cursor: pointer; border-radius: 5px; }';
			
			$html .= '.ui-slider{';
			if($bgSlider){$html .= 'background:'.$bgSlider.' !important;';}
			$html .= ' width:'.$sliderWidth.'px !important; height:'.$sliderHeight.'px !important; border:none; border-radius: 0; -moz-border-radius: 0; -webkit-border-radius: 0; cursor: pointer; margin: 5px 5px 20px 8px; }';
			
			$html .= '.ui-slider .ui-slider-range{';
			if($bgRange){$html .= 'background:'.$bgRange.' !important;';}
