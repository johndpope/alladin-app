...
$installer->addAttribute('catalog_category', 'umm_dd_type', array(
	...
	//'input_renderer'		=> '',
	//'frontend_class'		=> '',
	'source'				=> 'megamenu/category_attribute_source_dropdown_type',
...
$installer->addAttribute('catalog_category', 'umm_dd_proportions', array(
	...
	'backend'				=> 'megamenu/category_attribute_backend_grid_columns',
	'type'					=> 'varchar',
	'frontend'				=> '',
	'input'					=> 'text',
	'input_renderer'		=> 'megamenu/category_attribute_helper_grid_columns',
	//'frontend_class'		=> '',
...
$installer->addAttribute('catalog_category', 'umm_dd_columns', array(
	...
	//'input_renderer'		=> '',
	//'frontend_class'		=> '',
	'source'				=> 'megamenu/category_attribute_source_dropdown_columns',
...
$installer->addAttribute('catalog_category', 'umm_dd_blocks', array(
	...
	'backend'				=> 'megamenu/category_attribute_backend_dropdown_blocks',
	'type'					=> 'text',
	'frontend'				=> '',
	'input'					=> 'textarea',
	'input_renderer'		=> 'megamenu/category_attribute_helper_dropdown_blocks',
	//'frontend_class'		=> '',
...
$installer->updateAttribute('catalog_category', 'umm_cat_label', null, null, 500);
