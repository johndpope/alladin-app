 ...
 */
class Zozoconcepts_Featuredproductslider_Block_New extends Mage_Catalog_Block_Product_New
{
	...
	public function getProductCollection()
	{
		...
		$_productCollection_model = Mage::getModel('catalog/product')
									...
									->addAttributeToFilter('new_arrival', array('eq' => 1))
									->load(); 
									$_productCollection_model->setOrder('entity_id', 'desc');
