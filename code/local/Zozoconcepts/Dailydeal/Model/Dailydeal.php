...
class Zozoconcepts_Dailydeal_Model_Dailydeal extends Mage_Core_Model_Abstract
{
	...
	public function getSidebar($limit = 3, $method = '')
	{
		...
		switch ($method) {
			case Zozoconcepts_Dailydeal_Model_System_Config_Display::RANDOM:
				...
				break;
			case Zozoconcepts_Dailydeal_Model_System_Config_Display::TODAY:
			...
			case Zozoconcepts_Dailydeal_Model_System_Config_Display::THIS_WEEK:
			...
			case Zozoconcepts_Dailydeal_Model_System_Config_Display::THIS_MONTH:
