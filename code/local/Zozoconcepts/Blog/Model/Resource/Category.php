 ...
 */
class Zozoconcepts_Blog_Model_Resource_Category
    ...
    public function _construct(){
        $this->_init('zozoconcepts_blog/category', 'entity_id');
    }
    /**
    ...
    public function lookupStoreIds($categoryId){
        ...
        $select  = $adapter->select()
            ->from($this->getTable('zozoconcepts_blog/category_store'), 'store_id')
     ...
     * @return Zozoconcepts_Blog_Model_Resource_Category
     * @author Zozoconcepts Hybrid
     */
     ...
     * @param string $field
     * @param mixed $value
     * @param Zozoconcepts_Blog_Model_Category $object
    ...
    protected function _getLoadSelect($field, $value, $object){
        ...
        if ($object->getStoreId()) {
            ...
            $select->join(
                array('blog_category_store' => $this->getTable('zozoconcepts_blog/category_store')),
    ...
    protected function _afterSave(Mage_Core_Model_Abstract $object){
        ...
        $table  = $this->getTable('zozoconcepts_blog/category_store');
    ...
    protected function _initCheckUrlKeySelect($urlKey, $store){
        $select = $this->_getReadAdapter()->select()
            ...
            ->join(
                array('es' => $this->getTable('zozoconcepts_blog/category_store')),
