 ...
 */
class Zozoconcepts_Blog_Model_Resource_Blog_Collection
     ...
     * @return Zozoconcepts_Blog_Model_Resource_Blog_Collection
     * @author Zozoconcepts Hybrid
     */
    ...
    protected function _renderFiltersBefore(){
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                array('store_table' => $this->getTable('zozoconcepts_blog/blog_store')),
