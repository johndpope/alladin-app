...
class Zozoconcepts_Blog_Block_Adminhtml_Category_Widget_Chooser
    ...
    public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element){
        ...
        $sourceUrl = $this->getUrl('zozoconcepts_blog/adminhtml_blog_category_widget/chooser', array('uniq_id' => $uniqId));
        $chooser = $this->getLayout()->createBlock('widget/adminhtml_widget_chooser')
                ...
                ->setUniqId($uniqId);
        if ($element->getValue()) {
            $category = Mage::getModel('zozoconcepts_blog/category')->load($element->getValue());
            if ($category->getId()) {
                $chooser->setLabel($category->getCatName());
            }
        }
     ...
     * @access protected
     * @return Zozoconcepts_Blog_Block_Adminhtml_Category_Widget_Chooser
     * @author Zozoconcepts Hybrid
     */
    ...
    protected function _prepareColumns(){
        ...
        $this->addColumn('chooser_cat_name', array(
    ...
    public function getGridUrl(){
        return $this->getUrl('adminhtml/blog_category_widget/chooser', array('_current' => true));
    }
    /**
