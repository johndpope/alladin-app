 ...
 */
class Zozoconcepts_Blog_Block_Adminhtml_Category_Edit_Tab_Stores
    extends Mage_Adminhtml_Block_Widget_Form {
    /**
     * prepare the form
     * @access protected
     * @return Zozoconcepts_Blog_Block_Adminhtml_Category_Edit_Tab_Stores
     * @author Zozoconcepts Hybrid
     */
    protected function _prepareForm(){
        ...
        $this->setForm($form);
        $fieldset = $form->addFieldset('category_stores_form', array('legend'=>Mage::helper('zozoconcepts_blog')->__('Store views')));
