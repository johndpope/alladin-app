<?php
class Zozoconcepts_Hybrid_Model_Core_Layout extends Mage_Core_Model_Layout
{
     ...
     * @return Zozoconcepts_Hybrid_Model_Core_Layout
     */
    protected function _generateAction($node, $parent)
    {
        $compiler = Mage::getModel('hybrid/compiler');
