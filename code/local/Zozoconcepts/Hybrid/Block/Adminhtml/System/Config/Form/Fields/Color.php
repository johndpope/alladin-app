...
class Zozoconcepts_Hybrid_Block_Adminhtml_System_Config_Form_Fields_Color extends Mage_Adminhtml_Block_System_Config_Form_Field {

	protected function _getElementHtml( Varien_Data_Form_Element_Abstract $element ) {
		$html = $element->getElementHtml();
		$jsPath = $this->getJsUrl('hybrid/jquery/jquery-1.8.3.min.js');
		$mcpPath = $this->getJsUrl('hybrid/jquery/plugins/mcolorpicker/');
