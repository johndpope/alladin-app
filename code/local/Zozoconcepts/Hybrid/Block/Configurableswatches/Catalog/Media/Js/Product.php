<?php
class Zozoconcepts_Hybrid_Block_Configurableswatches_Catalog_Media_Js_Product extends Mage_ConfigurableSwatches_Block_Catalog_Media_Js_Product {
    public function getProductImageFallbacks($keepFrame = null) {
		...
		$keepFrame = Mage::getStoreConfig("hybrid/product_view/aspect_ratio",$code);
