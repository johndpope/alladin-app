<?php
class Zozoconcepts_Hybrid_Block_Configurableswatches_Catalog_Media_Js_List extends Mage_ConfigurableSwatches_Block_Catalog_Media_Js_List {
    public function getProductImageFallbacks($keepFrame = null) {
        /* @var $helper Mage_ConfigurableSwatches_Helper_Mediafallback */
        $helper = Mage::helper('hybrid/mediafallback');
		...
		$keepFrame = Mage::getStoreConfig("hybrid/category_page/aspect_ratio",$code);
