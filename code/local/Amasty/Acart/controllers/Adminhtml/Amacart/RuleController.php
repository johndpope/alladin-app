...
class Amasty_Acart_Adminhtml_Amacart_RuleController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function deleteAction()
    {
        ...
        if ($model->getId()) {
            $model->delete();
            $msg = $this->__('Rule has been successfully deleted');
    ...
    public function saveAction()
    {
        ...
        if ($data) {
            ...
            try {
                ...
                $msg = $this->__('Rule has been successfully saved');
        ...
        Mage::getSingleton('adminhtml/session')->addError($this->__('Unable to find a record to save'));
        $this->_redirect('*/*');
