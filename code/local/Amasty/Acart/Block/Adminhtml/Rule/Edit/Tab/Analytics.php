...
class Amasty_Acart_Block_Adminhtml_Rule_Edit_Tab_Analytics extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fldInfo->addField('utm_campaign', 'text', array(
            ...
            'name'      => 'utm_campaign',
            'note' => $hlp->__('<b>Required.</b> Used for keyword analysis. Use <b>utm_campaign</b> to identify a specific product promotion or strategic campaign.<br/><i>Example:</i> utm_campaign=spring_sale')
        ));
