...
class Mss_Connector_TokenController extends Mage_Core_Controller_Front_Action {
	...
	*/
	...
	public function getConfigurationAction(){
           ...
           // $config_data['google_clientid'] = Mage::getStoreConfig('mss_social/mss_google_key/client_id');
			// $config_data['google_clientid'] = Mage::getStoreConfig(self::XML_SETTING_GOOGLE_CLIENT_ID);
			$config_data['google_clientid'] = '654935589743-5hfenen2inirkimphnubs8a8nig001k0.apps.googleusercontent.com';
			...
			$config_data['google_analytic'] = Mage::getStoreConfig('google/analytics/account');
