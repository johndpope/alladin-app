<?php
class Mss_Mdirect_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    function configDetails() {
        ...
        // $configDetails['active'] = true;
        // $configDetails['title'] = 'Card Payments(Visa, Cba Loop, Mastercard)';
        // $configDetails['company_token'] = '6B55AC20-5F6E-4538-94D2-45011BB6A713';
        // $configDetails['gateway_url'] = 'https://secure.3gdirectpay.com';
        // $configDetails['ptl_type'] = 'Hours';
        // $configDetails['ptl'] = 24;
        // $configDetails['service_type'] = 5994;
        // $configDetails['aramex_url'] = '';
        // $configDetails['aramex_secret'] = '';
