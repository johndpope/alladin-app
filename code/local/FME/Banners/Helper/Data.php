...
class FME_Banners_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	*/
	...
	public function generateXML() {
			...
			$banners = Mage::getModel('banners/banners')->getCollection()
							...
							->addFieldToFilter('bannerimage',array('neq' => ''))
			...
			foreach ($banners as $_banner) {
				...
				$bannerImage = Mage::getBaseUrl('media').$_banner["bannerimage"]; 
