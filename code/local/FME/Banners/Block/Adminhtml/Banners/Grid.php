...
class FME_Banners_Block_Adminhtml_Banners_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  //     ));
    $this->addColumn('filethumbgrid', array(
            ...
            'index' => 'filethumbgrid',
            'width'     => '100',
            'renderer' => 'FME_Banners_Block_Adminhtml_Banners_Grid_Renderer_Image'
        )); 
