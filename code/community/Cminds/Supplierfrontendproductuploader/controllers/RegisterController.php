...
class Cminds_Supplierfrontendproductuploader_RegisterController extends Cminds_Supplierfrontendproductuploader_Controller_Action {
    ...
    public function createPostAction()
    {
        ...
        try {
            ...
            Mage::register("is_supplier_registration_process", true);
            if (empty($errors)) {
                ...
                Mage::helper('supplierfrontendproductuploader/email')
                    ->notifyAdminOnSupplierRegister($customer);
    ...
    protected function _successProcessRegistration(Mage_Customer_Model_Customer $customer)
    {
        ...
        if ($customer->isConfirmationRequired()) {
            ...
            if($this->_getHelper()->isSupplierNeedsToBeApproved()) {
                Mage::helper('supplierfrontendproductuploader/email')
                    ->notifySupplierNeedApprove($customer);
            }
            ...
            if($this->_getHelper()->isSupplierNeedsToBeApproved()) {
                ...
                Mage::getSingleton('customer/session')->addError(
                    Mage::helper('supplierfrontendproductuploader')
                        ->__('Thank you for creating account on our store. Your account must be approved by store admin. When it will be done we will send you an email.')
                );
                $url = Mage::getBaseUrl();
            } else {
