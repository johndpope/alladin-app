        ...
        */
        ...
        $collection->getSelect()
            ...
            ->joinLeft(
                ...
                'p.order_id = main_table.order_id AND p.supplier_id = e.value',
...
//        ));
        ...
        $this->addColumn('row_total_incl_tax', array(
            ...
            'type' => 'price',
            'align' => 'right',
            'renderer' => 'Cminds_Marketplace_Block_Adminhtml_Billing_List_Grid_Renderer_Totalprice'
        ));
        ...
        $this->addColumn('vendor_amount', array(
            ...
            'type' => 'price',
            'align' => 'right',
            'renderer' => 'Cminds_Marketplace_Block_Adminhtml_Billing_List_Grid_Renderer_Netincome'
        ));
