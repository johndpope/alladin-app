...
//            throw new Mage_Exception('Cminds Core Module is disabled or removed');
    ...
    /**
     * Get configuration value, in order to know if to include bootstrap.js file into the layout or not.
     * Return true -> include, false -> not include.
     *
     * @return int
     */
    public function includeBootstrapJs()
    {
        $config = Mage::getStoreConfig(
            'supplierfrontendproductuploader_catalog/supplierfrontendproductuploader_presentation/include_bootstrap_js'
        );
