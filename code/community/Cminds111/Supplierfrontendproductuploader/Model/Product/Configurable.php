<?php
class Cminds_Supplierfrontendproductuploader_Model_Product_Configurable extends Mage_Core_Model_Abstract {
    private $_product;
    ...
    /**
     * Get Simple Product's Attributes.
     *
     * @param $product
     * @return array
     */
    public function getSimpleProductValues($product)
    {
        $configurableAttributeCollection = $this->getProduct()->getTypeInstance()->getConfigurableAttributes();
