 ...
 * Post model
 *
 * @method \Zozothemes\Blog\Model\ResourceModel\Post _getResource()
 * @method \Zozothemes\Blog\Model\ResourceModel\Post getResource()
...
class Post extends \Magento\Framework\Model\AbstractModel
{
     ...
     */
    const BASE_MEDIA_PATH = 'zozothemes_blog';
     ...
     * @var string
     */
    protected $_eventPrefix = 'zozothemes_blog_post';
    ...
    /**
     * @var \Zozothemes\Blog\Model\ResourceModel\Category\CollectionFactory
     */
     ...
     * @param \Zozothemes\Blog\Model\ResourceModel\Category\CollectionFactory $categoryCollectionFactory
    ...
    public function __construct(
        ...
        Url $url,
        \Zozothemes\Blog\Model\ResourceModel\Category\CollectionFactory $categoryCollectionFactory,
    ...
    {
        $this->_init('Zozothemes\Blog\Model\ResourceModel\Post');
    }
    ...
    public function getRelatedPosts($storeId = null)
    {
        if (!$this->hasData('related_posts')) {
            ...
            $collection->getSelect()->joinLeft(
                ['rl' => $this->getResource()->getTable('zozothemes_blog_post_relatedpost')],
    ...
    public function getRelatedProducts($storeId = null)
    {
        if (!$this->hasData('related_products')) {
            ...
            $collection->getSelect()->joinLeft(
                ['rl' => $this->getResource()->getTable('zozothemes_blog_post_relatedproduct')],
