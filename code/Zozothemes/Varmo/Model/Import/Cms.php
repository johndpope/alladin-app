 ...
 */
namespace Zozothemes\Varmo\Model\Import;
...
class Cms
{
    ...
    public function __construct(
        ...
        $this->_importPath = BP . '/app/code/Zozothemes/Varmo/etc/import/';
    ...
    public function importCms($type)
    {
        ...
        try {
            ...
            if($this->_scopeConfig->getValue("varmo_settings/install/overwrite_".$type)) {
                $overwrite = true;
            }
