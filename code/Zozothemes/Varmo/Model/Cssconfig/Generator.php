...
namespace Zozothemes\Varmo\Model\Cssconfig;
...
class Generator
{
    ...
    public function __construct(
        \Zozothemes\Varmo\Helper\Cssconfig $cssconfigData,
    ...
    protected function generateStoreCss($type, $storeId) {
        ...
        $str4 = 'varmo/css/'.$type.'.phtml';
        $this->_coreRegistry->register('cssgen_store', $storeCode);

        try {
            $block = $this->_layoutManager->createBlock('Zozothemes\Varmo\Block\Template')->setData('area','frontend')->setTemplate($str4)->toHtml();
