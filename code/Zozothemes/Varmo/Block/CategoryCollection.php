...
class CategoryCollection extends \Magento\Framework\View\Element\Template
{
   ...
   public function getStoreCategories($sorted = false, $asCollection = false, $toLoad = true)
    ...
    public function getChildCategoryHtml($category, $icon_open_class="varmo-icon-plus-squared", $icon_close_class="varmo-icon-minus-squared") {
        $html = '';
    ...
    public function getCategorySidebarHtml($icon_open_class="varmo-icon-plus-squared", $icon_close_class="varmo-icon-minus-squared") {
        $html = '';
